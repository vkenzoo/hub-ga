/**
 * POST /api/admin/replay-invalid
 *
 * Reprocessa webhook_executions com status='invalid_payload'. Útil quando
 * o Zod schema rejeitou por bug (ex: campo null em z.string().optional()
 * em vez de .nullish()) e o schema foi corrigido.
 *
...
export async function POST() {
  ...
  // Pega todas invalid_payload de gateway pagador (assiny/hotmart) nos últimos 30 dias
  ...
  await logAudit({
    actor: auth.email,
    action: "execution.bulk_replay_invalid",
